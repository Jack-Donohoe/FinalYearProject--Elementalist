...
public abstract class PlayerBaseState : State
{
    ...
    protected void CalculateMoveDirection()
    {
        ...
        Vector3 moveDirection = cameraForward.normalized * stateMachine.PlayerInput.MoveDirection.y + cameraRight.normalized * stateMachine.PlayerInput.MoveDirection.x;
